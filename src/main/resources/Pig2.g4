...
nested_op_clause : '(' op_clause parallel_clause? ')'
...
inline_param_clause : '(' ( parameter (',' parameter)* )? ')';
...
implicit_tuple_type : '(' field_def_list? ')';

explicit_tuple_type : tuple implicit_tuple_type;

explicit_tuple_type_cast : TUPLE '(' ( explicit_type_cast ( ',' explicit_type_cast )* )? ')';
...
func_name_zero_args : func_name '(' ')';
func_name_with_args : func_name '(' func_args ')';
